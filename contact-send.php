<div class="content-banner">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h2><a href=".">Home</a> <i class="fa fa-angle-double-right"></i> <a href="./contact">Contact</a> <i class="fa fa-angle-double-right"></i> Contact Form Sending Processing...</h2>
            </div>
        </div>
    </div>
</div>
...
<?php
    ...
    $subject = "New Contact us from Website || American Paving.";
...
if(!@mail($to, $subject, $message, $headers))
    ...
    echo "<p style='color: #fff; margin: 0; padding: 20px 0; background: #27ae60; font-size: 25px; text-align: center;'>Your request was sent successfully, we will contact soon, thank you!</p>";
?>
<?php }
 ?>