<div class="content-banner">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h2><a href=".">Home</a> <i class="fa fa-angle-double-right"></i> Request a Quote</h2>
            </div>
        </div>
    </div>
</div>
...
<?php
    ...
    $subject = "Request A Quote from Website || American Paving.";
...
<?php
    ...
    <table rules="all" style="border:1px solid  #666; font-size:16px;" cellpadding="10" width="100%">
        ...
        <tr style='background: #eee;'>
            <td colspan="4"><strong>Job Details</strong></td>
        </tr>
        <tr>
